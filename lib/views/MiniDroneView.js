...
var MiniDroneView = exports.MiniDroneView = function () {
    ...
    _createClass(MiniDroneView, [{
        key: 'logging',
        value: function logging(enable) {
            var _this = this;

            return new Promise(function (resolve, reject) {
                try {
                    _this.pjson.debugging = enable;
                    resolve('success');
                } catch (e) {
                    reject(e);
                }
        ...
        value: function connect(droneIdentifier) {
            ...
            return new Promise(function (resolve, reject) {
                _this2.droneController.connect(droneIdentifier).then(function () {
        ...
        value: function checkAllStates() {
            ...
            return new Promise(function (resolve, reject) {
                _this3.droneController.checkAllStates().then(function () {
        ...
        value: function flatTrim() {
            ...
            return new Promise(function (resolve, reject) {
                _this4.droneController.sendPilotingCommand('piloting', 'flatTrim').then(function () {
        ...
        value: function takeOff() {
            ...
            return new Promise(function (resolve, reject) {
                _this5.droneController.sendPilotingCommand('piloting', 'takeOff').then(function () {
                    var callback = function callback(navObj) {
                        if (navObj.state === 'hovering') {
                            (0, _debug.debug)('Drone has took off');
                            _this5.droneController.removeListener('flyingStateChanged', callback);
                            (0, _sleep.sleep)(_this5.breathingTime).then(function () {
                                resolve('success');
                            });
                        }
                    };

                    _this5.droneController.on('flyingStateChanged', callback);
                }).catch(function (e) {
                    reject(e);
                });
            });
        ...
        value: function up(intensity, frequency) {
            ...
            return new Promise(function (resolve, reject) {
                if (!_this13._isValid(intensity)) {
                    reject('Error: Value for intensity should be between 0 and 100');
                }

                var args = [0, 0, 0, 0, intensity, 0];
                _this13._execManeuver(args, frequency).then(function () {
                    resolve('success');
                }).catch(function (e) {
                    reject(e);
                });
        ...
        value: function frontFlip() {
            ...
            return new Promise(function (resolve, reject) {
                _this14.droneController.sendPilotingCommand('animations', 'flip', [0, 0, 0, 0]).then(function () {
        ...
        value: function backFlip() {
            ...
            return new Promise(function (resolve, reject) {
                _this15.droneController.sendPilotingCommand('animations', 'flip', [1, 0, 0, 0]).then(function () {
        ...
        value: function rightFlip() {
            ...
            return new Promise(function (resolve, reject) {
                _this16.droneController.sendPilotingCommand('animations', 'flip', [2, 0, 0, 0]).then(function () {
        ...
        value: function leftFlip() {
            ...
            return new Promise(function (resolve, reject) {
                _this17.droneController.sendPilotingCommand('animations', 'flip', [3, 0, 0, 0]).then(function () {
                    (0, _sleep.sleep)(_this17.breathingTime + 1000).then(function () {
                        resolve('success');
                    });
                }).catch(function (e) {
                    reject(e);
        ...
        value: function takePicture() {
            ...
            return new Promise(function (resolve, reject) {
                _this18.droneController.sendPilotingCommand('mediaRecord', 'picture', [0]).then(function () {
        ...
        value: function listAllPictures() {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this19.droneController.sendMediaCommand('LIS', '/internal_000/Rolling_Spider/media').then(function () {}).catch(function (e) {
                    reject(e);
                });
            });
        }
        ...
        value: function downloadPicture(name, downloadPath) {
            ...
            return new Promise(function (resolve, reject) {
                var stream = _this20.fs.createWriteStream(downloadPath + '/' + name);
                ...
                var callback = function callback(mediaObj) {
                    if (mediaObj.state === 'GET' || mediaObj.state === 'MD5 OK') {
                        ...
                        if (dataStr.toLowerCase().indexOf('end of transfer') >= 0) {
                            ...
                            _this20.droneController.sendMediaCommand('MD5 OK', '').then(function () {}).catch(function (e) {
                                reject(e);
                            });
                        } else {
                ...
                _this20.droneController.sendMediaCommand('GET', '/internal_000/Rolling_Spider/media/' + name).then(function () {}).catch(function (e) {
                    reject(e);
                });
            });
        }
        ...
        value: function deletePicture(name) {
            ...
            return new Promise(function (resolve, reject) {
                    ...
                    if (mediaObj.state === 'DEL') {
                        ...
                        if (str.toLowerCase().indexOf('delete successful') >= 0) {
                            ...
                            if (confirmArr.length === 2) {
                                _this21.droneController.removeListener('media-data', callback);
                ...
                _this21.droneController.on('media-data', callback);

                _this21.droneController.sendMediaCommand('DEL', '/internal_000/Rolling_Spider/thumb/' + name).then(function () {}).catch(function (e) {
                    reject(e);
                });
                _this21.droneController.sendMediaCommand('DEL', '/internal_000/Rolling_Spider/media/' + name).then(function () {}).catch(function (e) {
                    reject(e);
                });
            });
        }
        ...
        value: function land() {
            ...
            return new Promise(function (resolve, reject) {
                _this22.droneController.sendPilotingCommand('piloting', 'landing').then(function () {
                    var callback = function callback(navObj) {
                        if (navObj.state === 'landed') {
                            (0, _debug.debug)('Drone has landed');
                            _this22.droneController.removeListener('flyingStateChanged', callback);
                    ...
                    _this22.droneController.on('flyingStateChanged', callback);
                }).catch(function (e) {
                    reject(e);
                });
            });
        ...
        value: function disconnect() {
            ...
            return new Promise(function (resolve, reject) {
                _this23.droneController.disconnect().then(function () {
                    (0, _debug.debug)('Drone disconnected successfully');
                    (0, _sleep.sleep)(_this23.breathingTime).then(function () {
                        resolve('success');
                    });
                }).catch(function (e) {
                    reject(e);
        ...
        value: function getNavDataStream() {
            ...
            return _Observable.Observable.create(function (observer) {
                ...
                _this24.droneController.on('data', function (navInfo) {
                    _this24.navdata[navInfo.name] = {};
                    navInfo.args.forEach(function (arg) {
                        _this24.navdata[navInfo.name][arg.name] = arg.value;
                    });
                    observer.next(_this24.navdata);
                });
        ...
        value: function _execManeuver(args, frequency) {
            ...
            return new Promise(function (resolve, reject) {
                _this25.cmdInterval = setInterval(function () {
                    if (frequency > 0) {
                        _this25.droneController.sendPilotingCommand('piloting', 'maneuver', args).then().catch(function (e) {
                            reject(e);
                        });
                        frequency--;
                    } else {
                        clearInterval(_this25.cmdInterval);
                        resolve('success');
                    }
                }, _this25.breathingTime);
            });
        }
    }, {
        key: '_isValid',
